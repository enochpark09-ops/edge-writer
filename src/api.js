...
--- 문서 4. 로드맵 (성장 문서 — 10화 단위로 갱신되는 중장기 화별 계획) ---
${work.docs.roadmap || '(아직 작성되지 않음 — 로드맵 미기재 구간은 기획안의 대분류 구조만으로 판단할 것)'}
...
5. 로드맵체크: 이번 화가 로드맵에 지정된 아크·시점보다 앞서 요소(도핑, 확률 조작, 특정 인물 등장 등)를 조기 노출하지 않는가. 로드맵 미기재 구간은 이 항목을 건너뛴다.
6. 분량판정: 목표 분량 대비 평가
7. 훅판정: 회차 말미가 다음 화 클릭을 유도하는가
